    ...
    <div className="min-h-screen bg-background flex" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-14 md:h-16 bg-card/80 backdrop-blur-xl border-b border-border flex items-center px-3 md:px-6 sticky top-0 z-10">
          {isRTL && <h2 className="text-base md:text-lg font-semibold text-foreground truncate order-last ml-auto">{title}</h2>}
          <button
          ...
          {!isRTL && <h2 className="text-base md:text-lg font-semibold text-foreground flex-1 truncate">{title}</h2>}
