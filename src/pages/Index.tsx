...
const Index = () => {
  ...
  const services = [
    { icon: Leaf, title: isRTL ? "تشخيص أمراض النبات" : "Plant Disease Detection", desc: isRTL ? "تحليل فوري لأمراض النبات بالصور" : "Instant plant disease analysis from photos", gradient: "from-emerald-500 to-green-600" },
    { icon: Eye, title: isRTL ? "تقدير وزن الحيوان" : "Animal Weight Estimation", desc: isRTL ? "تقدير دقيق لوزن الحيوان بالذكاء الاصطناعي" : "Accurate AI-powered animal weight estimation", gradient: "from-blue-500 to-indigo-600" },
    { icon: Sprout, title: isRTL ? "توصية المحاصيل" : "Crop Recommendation", desc: isRTL ? "توصيات ذكية للمحاصيل المناسبة" : "Smart crop suggestions based on your soil", gradient: "from-amber-500 to-orange-600" },
    { icon: FlaskConical, title: isRTL ? "تحليل التربة" : "Soil Analysis", desc: isRTL ? "تحليل شامل لخصائص التربة" : "Comprehensive soil property analysis", gradient: "from-purple-500 to-violet-600" },
    { icon: Apple, title: isRTL ? "جودة الفاكهة" : "Fruit Quality", desc: isRTL ? "فحص جودة الفاكهة وتصنيفها" : "Fruit quality inspection and grading", gradient: "from-rose-500 to-pink-600" },
    { icon: MessageCircle, title: isRTL ? "روبوت الدردشة" : "Smart Chatbot", desc: isRTL ? "مساعد ذكي للإجابة على أسئلتك الزراعية" : "AI assistant for your farming questions", gradient: "from-cyan-500 to-teal-600" },
  ];

  const testimonials = [
    { name: isRTL ? "أحمد محمد" : "Ahmed Mohamed", role: isRTL ? "مزارع قمح" : "Wheat Farmer", text: isRTL ? "ساعدني النظام في اكتشاف أمراض النبات مبكراً وتقليل الخسائر بنسبة 40%" : "The system helped me detect plant diseases early and reduce losses by 40%", stars: 5 },
    { name: isRTL ? "سارة علي" : "Sara Ali", role: isRTL ? "مهندسة زراعية" : "Agricultural Engineer", text: isRTL ? "أداة رائعة لتحليل التربة وتوصية المحاصيل المناسبة لكل موسم" : "Great tool for soil analysis and recommending the right crops for each season", stars: 5 },
    { name: isRTL ? "محمد حسن" : "Mohamed Hassan", role: isRTL ? "مربي ماشية" : "Livestock Farmer", text: isRTL ? "تقدير وزن الحيوانات بالصور وفر لي وقت ومجهود كبير" : "Animal weight estimation by photos saved me a lot of time and effort", stars: 5 },
  ];
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden" dir={isRTL ? "rtl" : "ltr"}>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-foreground mb-3 sm:mb-4">
              {isRTL ? "6 خدمات ذكاء اصطناعي" : "6 AI-Powered Services"}
            </h2>
            <p className="text-muted-foreground text-sm sm:text-lg max-w-2xl mx-auto">
              {isRTL ? "أدوات متقدمة لتحليل المحاصيل والتربة والحيوانات" : "Advanced tools for crop, soil, and animal analysis"}
            </p>
          </motion.div>
      ...
      <section className="py-14 sm:py-24 bg-card/50 relative">
        <div className="container mx-auto px-4 sm:px-6 relative">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-foreground mb-3 sm:mb-4">{t("index.featuresTitle")}</h2>
            <p className="text-muted-foreground text-sm sm:text-lg max-w-2xl mx-auto">{t("index.featuresDesc")}</p>
          </motion.div>
      ...
      {/* How it works - Redesigned with connecting line */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="text-sm sm:text-base text-foreground leading-relaxed mb-5" dir="auto">{t.text}</p>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-primary-foreground/80 text-sm sm:text-lg mb-6 sm:mb-8 max-w-xl mx-auto">{t("index.ctaDesc")}</p>
              
              {/* Checklist */}
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-8 sm:mb-10">
                {(isRTL
                  ? ["مجاني للتجربة", "بدون بطاقة ائتمان", "نتائج فورية"]
                  : ["Free to try", "No credit card", "Instant results"]
                ).map((item, i) => (
      ...
      <footer className="bg-card border-t border-border py-10 sm:py-14">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm max-w-md">{t("index.footer")}</p>
          </div>
        </div>
      </footer>
    </div>
