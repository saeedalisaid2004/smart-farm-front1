...
const AdminDashboard = () => {
  ...
  const statsCards = [
    ...
    { icon: Cpu, label: t("adminDash.aiServices"), value: summary?.active_services ?? "6 / 6", sub: t("adminDash.active"), badge: t("adminDash.allOnline"), gradient: "from-purple-500 to-violet-600", bgGlow: "bg-purple-500/10" },
