...
const AdminReports = () => {
  ...
  const statsCards = [
    ...
    { icon: Globe, label: t("adminReports.aiServices"), value: data?.ai_services_count ? String(data.ai_services_count).replace(/\s*of\s*/i, " / ") : "6 / 6", change: data?.uptime_ratio || t("adminReports.uptimePercent"), gradient: "from-purple-500 to-violet-600" },
